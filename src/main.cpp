...
int main(int agrc, char **argv)
{
    ...
    std::ifstream arquivo("20242TP2.csv"); // abre o arquivo
    ...
    auto duration = std::chrono::duration_cast<std::chrono::microseconds>(stop0 - start);
    std::cout << "Tempo de inserção: " << duration.count() << " milissegundos" << std::endl;
    ...
    std::cout << "Tempo de atendimento: " << duration1.count() << " milissegundos" << std::endl;
    ...
    std::cout << "Tempo de execução: " << duration2.count() << " milissegundos" << std::endl;
    return 0;
}
