...
void Paciente::print_paciente()
{
    ...
    std::cout << id << " "
              ...
              << anoout << " "
              << std::fixed << std::setprecision(2) << horafila - horain << " "
...
float horatotal(int ano, int mes, int dia, int hora)
{
...
void Paciente::calculateDateTime(int totalHours)
{
    int year = 2017;
